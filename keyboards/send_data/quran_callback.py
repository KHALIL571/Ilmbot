...
from keyboards.inline.quran_Inline import quraninline1, quraninline2, quraninline3, quraninline4, quraninline5, quraninline6, quraninline7, quraninline8
from keyboards.default.menuKeyboard import quron

@dp.message_handler(text="Qur'onga o'tish📖")
async def regions_callback(msg: Message):
    await msg.answer('01- Fotiha surasi\n02- Baqara surasi\n03- Oli Imron surasi\n04- Niso surasi\n05- Moida surasi\n06- An’om surasi\n07- A’rof surasi\n08- Anfol surasi\n09- Tavba surasi\n10- Yunus surasi\n11- Hud surasi\n12- Yusuf surasi\n13- Ra’d surasi\n14- Ibrohim surasi',reply_markup=quraninline1)
