...
quraninline1 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='01', callback_data='1'),
            InlineKeyboardButton(text='02', callback_data='2'),
            InlineKeyboardButton(text='03', callback_data='3'),
            InlineKeyboardButton(text='04', callback_data='4'),
            InlineKeyboardButton(text='05', callback_data='5'),
            InlineKeyboardButton(text='06', callback_data='6'),
            InlineKeyboardButton(text='07', callback_data='7'),
        ],
        [
            InlineKeyboardButton(text='08', callback_data='8'),
            InlineKeyboardButton(text='09', callback_data='9'),
...
quraninline2 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
...
quraninline3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
...
quraninline4 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
        ...
        [
            InlineKeyboardButton(text='50', callback_data='52'),
...
quraninline5 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
...
quraninline6 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
        ...
        [
            ...
            InlineKeyboardButton(text='81', callback_data='81'),
            InlineKeyboardButton(text='82', callback_data='82'),
            InlineKeyboardButton(text='83', callback_data='83'),
            InlineKeyboardButton(text='84', callback_data='84')
        ],
        [
            InlineKeyboardButton(text='⬅️',callback_data='<5'),
...
quraninline7 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='85', callback_data='85'),
            InlineKeyboardButton(text='86', callback_data='86'),
            InlineKeyboardButton(text='87', callback_data='87'),
            InlineKeyboardButton(text='88', callback_data='88'),
            InlineKeyboardButton(text='89', callback_data='89'),
            InlineKeyboardButton(text='90', callback_data='90'),
            InlineKeyboardButton(text='91', callback_data='91'),
        ],
        [
            InlineKeyboardButton(text='92', callback_data='92'),
            InlineKeyboardButton(text='93', callback_data='93'),
            InlineKeyboardButton(text='94', callback_data='94'),
            InlineKeyboardButton(text='95', callback_data='95'),
            InlineKeyboardButton(text='96', callback_data='96'),
            InlineKeyboardButton(text='97', callback_data='97'),
            InlineKeyboardButton(text='98', callback_data='98')
        ],
        [
            InlineKeyboardButton(text='⬅️',callback_data='<6'),
...
quraninline8 = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text='99', callback_data='99'),
            InlineKeyboardButton(text='100', callback_data='100'),
            InlineKeyboardButton(text='101', callback_data='101'),
            InlineKeyboardButton(text='102', callback_data='102'),
            InlineKeyboardButton(text='103', callback_data='103'),
            InlineKeyboardButton(text='104', callback_data='104'),
            InlineKeyboardButton(text='105', callback_data='105'),
            InlineKeyboardButton(text='106', callback_data='106'),
        ],
        [
            InlineKeyboardButton(text='107', callback_data='107'),
            InlineKeyboardButton(text='108', callback_data='108'),
            InlineKeyboardButton(text='109', callback_data='109'),
            InlineKeyboardButton(text='110', callback_data='110'),
            InlineKeyboardButton(text='111', callback_data='111'),
            InlineKeyboardButton(text='112', callback_data='112'),
            InlineKeyboardButton(text='113', callback_data='113'),
            InlineKeyboardButton(text='114', callback_data='114')
        ],
        [
            InlineKeyboardButton(text='⬅️',callback_data='<7'),
        ]
